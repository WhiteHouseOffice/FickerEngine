...
static void setMouseCaptured(GLFWwindow* window, bool captured) {
  ...
  // ✅ This is the mode that actually confines/locks the mouse to the window
  glfwSetInputMode(window, GLFW_CURSOR, captured ? GLFW_CURSOR_DISABLED : GLFW_CURSOR_NORMAL);

  // Raw mouse motion helps in some environments
...
static void glfw_cursor_pos_callback(GLFWwindow* /*window*/, double x, double y) {
  ...
  // Clamp spikes (WSLg/Wayland can produce occasional weird jumps)
